package br.com.CarlosHenriqueSL.file.importer.impl;
...
public class XlsxImporter implements FileImporter {
    ...
    public List<PersonDTO> importFile(InputStream inputStream) throws Exception {
        ...
        /* Gets the .xlsx file, gets the correct sheet (getSheetAt(0)). Skips the header.
         * Starts to parse every row to a PersonDTO object, and returns the list.
         */
