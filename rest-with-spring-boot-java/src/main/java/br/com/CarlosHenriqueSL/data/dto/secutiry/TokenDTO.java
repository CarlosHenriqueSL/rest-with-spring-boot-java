...
public class TokenDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getUsername(), tokenDTO.getUsername()) && Objects.equals(getAuthenticated(), tokenDTO.getAuthenticated()) && Objects.equals(getCreatedAt(), tokenDTO.getCreatedAt()) && Objects.equals(getExpiration(), tokenDTO.getExpiration()) && Objects.equals(getAccessToken(), tokenDTO.getAccessToken()) && Objects.equals(getRefreshToken(), tokenDTO.getRefreshToken());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getUsername(), getAuthenticated(), getCreatedAt(), getExpiration(), getAccessToken(), getRefreshToken());
    }
}
